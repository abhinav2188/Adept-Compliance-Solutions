...
const Product = (props) => {
    return (
    <div className={`flex flex-col bg-gray-light rounded shodow overflow-hidden transition-all duration-100 customClass transform ${props.className} hover:-translate-y-4`}>
