  ...
  return (
    <div className="w-full flex flex-col items-center py-8 relative xl:mb-16 lg:mb-12 md:mb-10 mb-6">
      ...
      <div className="absolute top-0 bg-gray-mid w-full overflow-hidden text-gray-dark h-128 lg:h-136">
        ...
        <div
          className="xl:h-48 xl:w-48 lg:w-36 lg:h-36 md:h-36 md:w-36 w-24 h-24 absolute md:top-0 bottom-0 md:translate-y-48 md:translate-x-24 lg:translate-y-48 translate-x-24 -translate-y-64 transform xl:translate-y-32 xl:translate-x-64 shadow-lg rounded-lg xl:px-6 xl:py-4 md:px-4 md:py-4 overflow-hidden p-2"
        ...
        <div
          className="absolute xl:h-64 xl:w-64 lg:w-48 lg:h-48 md:h-40 md:w-40 w-32 h-32 bottom-0 transform xl:translate-y-12 xl:translate-x-32 lg:translate-y-12 md:translate-x-4 lg:translate-x-8 md:translate-y-6 translate-x-4 -translate-y-48 shadow-lg rounded-lg overflow-hidden xl:px-6 xl:py-4 md:pl-4 md:pr-10 md:py-4 p-2 "
          style={{ backgroundColor: "#897979" }}
        >
          <img className="top-1/5 left-1/5 absolute -z-10" src={tsvg} alt="" />
          <h4>Transparency and Pre-reminders</h4>
        </div>
        <div
          className="xl:h-48 xl:w-48 lg:w-36 lg:h-36 md:w-36 md:h-36 w-24 h-24 absolute bottom-0 right-0 transform xl:-translate-y-64 lg:-translate-x-32 md:-translate-x-16 md:-translate-y-48 -translate-x-32 -translate-y-48 xl:-translate-x-64 shadow-lg rounded-lg xl:px-6 xl:py-4 md:px-4 overflow-hidden p-2"
          style={{ backgroundColor: "#5B7B79" }}
        >
          <h4>Proficent and Skilled</h4>
          <img className="top-1/5 left-1/5 absolute -z-10" src={psvg} alt="" />
        </div>
        <div
          className="xl:h-48 xl:w-48 lg:h-40 lg:w-40 md:w-36 md:h-36 h-32 w-32 absolute bottom-0 right-0 transform xl:-translate-y-8 xl:-translate-x-32 lg:-translate-x-8 lg:translate-y-4 md:-translate-x-4 md:-translate-y-4 -translate-x-4 -translate-y-32 shadow-lg rounded-lg xl:px-6 xl:py-4 md:p-4 p-2 overflow-hidden"
